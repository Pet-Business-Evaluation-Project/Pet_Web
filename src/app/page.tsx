    ...
    <>
      ...
      <div className="flex flex-col items-center justify-center py-12 md:py-20 bg-white border-t border-gray-200">
        ...
        <div className="flex flex-col md:flex-row w-full gap-8 px-4 max-w-7xl mx-auto mb-16">
          <section className="flex-1 bg-white py-12 px-8 text-center rounded-xl shadow-lg border border-gray-200 hover:shadow-2xl hover:-translate-y-1 transition-all duration-300">
          ...
          <section className="flex-1 bg-gradient-to-br from-blue-50 to-blue-100 py-12 px-8 text-center rounded-xl shadow-lg border border-blue-200 hover:shadow-2xl hover:-translate-y-1 transition-all duration-300">
            <h2 className="text-2xl font-bold mb-4 text-blue-800">회원사 소개</h2>
            <p className="text-gray-700 leading-relaxed">회원사 정보를 간단히 보여주는 영역입니다.</p>
          </section>

          <section className="flex-1 bg-gradient-to-br from-indigo-50 to-indigo-100 py-12 px-8 text-center rounded-xl shadow-lg border border-indigo-200 hover:shadow-2xl hover:-translate-y-1 transition-all duration-300">
            <h2 className="text-2xl font-bold mb-4 text-indigo-800">회원사 등록</h2>
